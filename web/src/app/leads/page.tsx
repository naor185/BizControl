...
export default function LeadsPage() {
    ...
    if (loading) return (
        <RequireAuth><AppShell title="דשבורד">
            <DashboardTabs />
    ...
    return (
        <RequireAuth>
            <AppShell title="דשבורד">
                <div className="pb-3"><DashboardTabs /></div>
                ...
                {/* Create / Edit modal */}
                {modal && (
                    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center bg-black/40 px-4" onClick={() => setModal(null)}>
