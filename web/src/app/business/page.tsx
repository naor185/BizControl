...
const SECTION_GROUPS: { groupLabel: string; icon: string; items: { href: string; label: string; description: string; icon: string; gradient: string; module?: string }[] }[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { href: "/message-templates", label: "תבניות הודעות", description: "תבניות לוואטסאפ ומייל",                 icon: "✉️", gradient: "from-pink-600 to-rose-700" },
            { href: "/broadcasts",        label: "תפוצות",        description: "הודעות המוניות ומבצעים",                icon: "📢", gradient: "from-amber-600 to-orange-700", module: "broadcasts" },
            { href: "/wait-list",         label: "רשימת המתנה",   description: "לקוחות הממתינים לתור פנוי",             icon: "⏳", gradient: "from-rose-600 to-pink-700",    module: "wait_list" },
        ],
    },
    {
        ...
        icon: "🎁",
        items: [
            { href: "/products",   label: "מוצרים ומלאי",     description: "קטלוג מוצרים, מחירים ומלאי",             icon: "📦", gradient: "from-sky-500 to-sky-700", module: "products" },
            { href: "/services",   label: "שירותים",          description: "סוגי טיפול, מחירים ומשך זמן",            icon: "🛎️", gradient: "from-sky-600 to-cyan-700", module: "services" },
            { href: "/gift-cards", label: "כרטיסי מתנה",      description: "מכירה ומעקב כרטיסי מתנה",                icon: "🎁", gradient: "from-purple-600 to-fuchsia-700", module: "pos" },
