            ...
            {STEPS.map((s, i) => (
                <div key={s.id} className="flex items-center flex-1 last:flex-none">
                    <div className="flex flex-col items-center">
                        <div className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold transition-all ${current > s.id ? "bg-indigo-500 text-white" : current === s.id ? "bg-slate-900 text-white" : "bg-slate-200 text-slate-400"}`}>
                            {current > s.id ? "✓" : s.id}
                        </div>
                            ...
                            {step === 1 && (
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <input type="password" dir="ltr" value={pass} onChange={e => setPass(e.target.value)} placeholder="••••••••••••••••" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-indigo-500" />
                                    </div>
