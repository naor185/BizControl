...
const ARTICLES: Article[] = [
        ...
        content: [
            ...
            },
            {
                ...
                steps: [
                    ...
                    "בחר את נותן/ת השירות מהרשימה (חייב להיות רשום בצוות).",
            ...
            },
            {
                ...
                table: [
                    ...
                    { col1: "סינון לפי נותן/ת שירות", col2: "בחר שם מהרשימה מעל היומן" },
                ],
            },
        ],
    },
    ...
    },
    {
        ...
        content: [
            {
                text: "מאגר כל לקוחות העסק עם פילטרים, חיפוש, וניהול קל.",
            },
            {
    ...
    },
    {
        ...
        content: [
            {
                text: "ניהול מלאי המוצרים שאתה מוכר בעסק — מוצרי טיפוח, ציוד ועוד.",
            },
            {
                heading: "הוספת מוצר",
                steps: [
    ...
    },
    {
        ...
        content: [
            {
                text: "ניהול חברי הצוות — מטפלים, עובדים ומנהלים. כל אחד מקבל כניסה, צבע ביומן, ושיטת שכר.",
            },
            {
    ...
    },
    {
        ...
        content: [
            ...
            },
            {
                ...
                steps: [
                    "הגדרות → 'דפי נחיתה'.",
                    "כתוב תיאור עסק בשדה (לדוגמה: 'עסק בוטיק, שירות אישי ואווירה נעימה').",
                    "לחץ 'צור עיצוב'.",
            ...
            },
            {
                ...
                tip: "לינק דף הנחיתה: [הדומיין שלך]/join/[מזהה העסק]. שים אותו בביו של האינסטגרם!",
            },
        ],
    },
    {
        ...
        content: [
            ...
            },
            {
                ...
                table: [
                    ...
                    { col1: "{artist_name}", col2: "שם נותן/ת השירות" },
                    { col1: "{staff_title}", col2: "איך העסק קורא לנותן/ת השירות (למשל: מטפל/ת, מדריך/ה)" },
                    ...
                    { col1: "{studio_address}", col2: "כתובת העסק" },
    ...
    },
    {
        ...
        content: [
            {
                text: "TikTok ו-Google לא מאפשרים גישה ל-DMs דרך API. הדרך לקבל לידים מהם היא להוביל את המשתמשים לדף הנחיתה של העסק עם UTM parameters — המערכת יוצרת ליד אוטומטית.",
            },
            {
                heading: "איך זה עובד",
                steps: [
    ...
    },
    {
        ...
        content: [
            {
                text: "דף ציבורי שהלקוח ממלא כדי להצטרף למועדון. לינק: [הדומיין שלך]/join/[מזהה העסק].",
            },
            {
            ...
            },
            {
                ...
                tip: "שים את הלינק בביו של האינסטגרם, בסטורי, ובQR על הקיר בעסק!",
            },
        ],
    },
    {
        ...
        content: [
            ...
            },
            {
                ...
                steps: [
                    ...
                    "בעל העסק מאמת בלוח הבקרה ← לחץ 'אמת תשלום ✅'.",
